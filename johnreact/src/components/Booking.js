                ...
                <div className="container">
                    <div className="row bg-light border">
                        ...
                        <div className="col-lg-3 pt-4 px-4 border-right">
                            ...
                            <p className="card-text"><i className="far fa-calendar-alt"></i> Tuesday 29/01/2019, 17:00
                                    </p>
                            <p className="card-text"><i className="fas fa-map-marked-alt"></i> Three Laloun 101,
                                        PETRALONA, ATTIKI</p>
                        </div>
                        <div className="col-lg-3 p-5">
                            <button type="button" className="btn btn-primary btn-block">CONTACT TRAINER</button>
                            <button type="button" className="btn btn-danger btn-block">CANCEL <i
